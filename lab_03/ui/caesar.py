...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(902, 881)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(260, 0, 391, 61))
        font = QtGui.QFont()
        ...
        self.label_2.setGeometry(QtCore.QRect(30, 130, 181, 41))
        font = QtGui.QFont()
        ...
        self.label_3.setGeometry(QtCore.QRect(40, 260, 171, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_4.setGeometry(QtCore.QRect(30, 470, 211, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.btn_encrypt.setGeometry(QtCore.QRect(260, 620, 141, 61))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.btn_decrypt.setGeometry(QtCore.QRect(660, 620, 141, 61))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.txt_cipher.setGeometry(QtCore.QRect(260, 460, 541, 87))
        self.txt_cipher.setObjectName("txt_cipher")
        self.txt_key = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_key.setGeometry(QtCore.QRect(260, 240, 541, 87))
        self.txt_key.setObjectName("txt_key")
        self.txt_plaintext = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_plaintext.setGeometry(QtCore.QRect(260, 100, 541, 87))
